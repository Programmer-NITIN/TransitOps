...
router.put('/:id', authorize('Fleet Manager', 'Driver'), ctrl.update);
router.patch('/:id/status', authorize('Fleet Manager', 'Driver'), [body('status').isIn(['Draft', 'Dispatched', 'Completed', 'Cancelled']).withMessage('Invalid status')], validate, ctrl.updateStatus);
